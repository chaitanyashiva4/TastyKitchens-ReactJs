...
const CartItem = props => (
  <CartContext.Consumer>
    {value => {
      ...
      return (
        <li data-testid="cartItem" className="cart_item">
          <div data-testid="cartItem" className="cart_item_title">
            <img className="cart_item_image" src={imageUrl} alt={name} />
            <h1 className="cart_item_name">{name}</h1>
          </div>

          <div data-testid="cartItem" className="cart_qty_price">
            ...
            <div className="cart_buttons_container">
              ...
              <p data-testid="item-quantity" className="cart_item_quantity">
                {quantity}
              </p>
